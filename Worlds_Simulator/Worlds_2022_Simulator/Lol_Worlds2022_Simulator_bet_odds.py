...
head_to_head_odds_play_in_group = {
                        ...
                        "CHF" : {"FNC" : 4.34, "DFM" : 2.14, "CHF" : 2.12, "LOD" : 1.68, "EG" : 3.41},
...
main_group_A = ["C9", "T1", "EDG"]
records_main_group_A = {"C9" : [], "T1" : [], "EDG" : []}
group_A_main_init = Group(main_group_A, records_main_group_A)

main_group_B = ["JDG", "G2", "DWG"]
records_main_group_B = {"JDG" : [], "G2" : [], "DWG" : []}
group_B_main_init = Group(main_group_B, records_main_group_B)

main_group_C = ["RGE", "TES", "GAM"]
records_main_group_C = {"RGE" : [], "TES" : [], "GAM" : []}
group_C_main_init = Group(main_group_C, records_main_group_C)

main_group_D = ["GEN", "CTO", "100T"]
records_main_group_D = {"GEN" : [], "CTO" : [], "100T" : []}
...
dict_res_main_A = {"C9" : [], "T1" : [], "EDG" : []}
dict_res_main_B = {"JDG" : [], "G2" : [], "DWG" : []}
dict_res_main_C = {"RGE" : [], "TES" : [], "GAM" : []}
dict_res_main_D = {"GEN" : [], "CTO" : [], "100T" : []}
